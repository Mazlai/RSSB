...
<head>
    ...
    <title>RSSB - Personnes âgées</title>
</head>
<body>
        ...
        echo('<div class="container">
            ...
            <div class="head-container">
                <div class="image-title-container">
                    <img class="head-image-single" src="./include/images/site/agées.png" alt="Logo RSSB">
                </div>
                <div class="title-container">
                    <h1 id="head-title3">personnes âgées</h1>
                </div>
                <div class="separator-container">
                    <hr id="head-separator3">
                </div>
            </div>');

            $reqPDF = $bdd->prepare("SELECT * FROM PDF WHERE FILEPATHPDF = :pFilePathPDF");
            $reqPDF->execute(array(":pFilePathPDF" => "./include/pdf/agees/"));
            ...
            if($reqPDF->rowCount() > 0) {
                ...
                if(isset($_SESSION['idMembre']) && $_SESSION['roleMembre'] == 'Admin') {
                    echo('<form class="button-form" action="./traitement/traitSuppPDFAgees.php" method="post" onsubmit="return confirm(\'Êtes-vous sûr de vouloir supprimer ce PDF ?\')">
                ...
                if(isset($_SESSION['idMembre']) && $_SESSION['roleMembre'] == 'Admin') {
                    ...
                    echo('<div class="body2-content">
                        <form class="formImage" action="./traitement/traitAddPDFAgees.php" method="post" enctype="multipart/form-data">
