...
<body>
    ...
    <?php
        ...
        echo('<div class="container">
            ...
            $reqPDF->execute(array(":pFilePathPDF" => "./include/pdf/benevoles/"));
            ...
            if($reqPDF->rowCount() > 0) {
                ...
                if(isset($_SESSION['idMembre']) && $_SESSION['roleMembre'] == 'Admin') {
                    echo('<form class="button-form" action="./traitement/traitSuppPDFFormations.php" method="post" onsubmit="return confirm(\'Êtes-vous sûr de vouloir supprimer ce PDF ?\')">
                ...
                if(isset($_SESSION['idMembre']) && $_SESSION['roleMembre'] == 'Admin') {
                    ...
                    echo('<div class="body2-content">
                        <form class="formImage" action="./traitement/traitAddPDFFormations.php" method="post" enctype="multipart/form-data">
